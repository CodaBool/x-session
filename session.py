...
async def login_and_get_cookies(username, password, totp_seed=None, headless=False):
    ...
    browser = await uc.start(
        headless=headless,
        browser_executable_path="/var/lib/flatpak/exports/bin/com.google.Chrome",
        # browser_executable_path=os.environ.get("BROWSER_BIN") or "com.google.Chrome",
    )
...
async def main():
    ...
    try:
        ...
        if append_file:
            ...
            print(output)
        print('exiting now', file=sys.stderr)
        return
